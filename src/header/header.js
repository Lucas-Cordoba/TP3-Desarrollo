        ...
        <header className='bg-light shadow p-3 mb-2 bg-white rounded sticky-top'>
            <div className="container">
                <div className="row flex-lg-row">
                    ...
                    <div className="col-lg-4 col-6 mb-2 d-flex justify-content-center align-items-center">
                        <nav>
                            <ul className="nav m-0">
                                <li className="nav-item me-0 text-center">
                    ...
                    <div className="col-lg-4 col-6 mb-2 d-flex justify-content-center align-items-center">
                        <ContadorCarrito className="ms-0" />
                    </div>
                </div>
            </div>
        </header>
